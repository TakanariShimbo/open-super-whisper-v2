...
2. [メイン画面](#メイン画面)
3. [API キー画面](#api-キー画面)
4. [インストラクションセット画面](#インストラクションセット画面)
5. [設定画面](#設定画面)
6. [システムトレイ](#システムトレイ)
7. [実際の使用例](#実際の使用例)
...
1. **インストラクションセット**（例：「文字起こしエージェント」）を選択し、**「録音開始」ボタンをクリック** または **設定したホットキーを押す**
2. マイクに向かって明瞭に話す
3. **「録音停止」ボタンをクリック** または **再度ホットキーを押す**
4. STT 出力タブで音声認識結果を確認
5. LLM 出力タブで AI 処理結果を確認
