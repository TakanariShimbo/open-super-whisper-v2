...
話すだけで、MCP に対応した AI エージェントがあなたの意図を理解し、自律的にタスクを実行します。PyQt6 ベースの強力なデスクトップアプリケーションで、OpenAI の Speech to text API と Agent SDK をシームレスに統合。音声による指示から、文書作成、情報検索、Web 操作まで、あなたの日常業務を革新的に効率化します。
...
- **OpenAI Agent SDK 利用** - インストラクションセットで用途別に特化した AI エージェントを利用可能
