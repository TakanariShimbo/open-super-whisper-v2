...
This module provides the view component for the settings dialog in the Super Whisper application.
...
class SettingsDialog(QDialog):
    ...
    def _on_sound_toggled(self, enabled: bool) -> None:
        ...
        enabled : bool
            New checkbox state
        """
        self._controller.set_sound_enabled(enabled)
    ...
    def _on_indicator_toggled(self, visible: bool) -> None:
        ...
        visible : bool
            New checkbox state
        """
        self._controller.set_indicator_visible(visible)
