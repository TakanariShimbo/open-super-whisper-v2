...
class InstructionSetsManager:
    ...
    def get_selected_set(self) -> InstructionSet | None:
        ...
        return self._instruction_sets_manager.find_set_by_name(name=self._selected_set_name)
    ...
    def set_selected_set_name(self, instruction_set_name: str) -> bool:
        ...
        """
        instruction_set = self._instruction_sets_manager.find_set_by_name(name=instruction_set_name)
    ...
    def add_set(self, instruction_set: InstructionSet) -> bool:
        ...
        """
        return self._instruction_sets_manager.add_set(instruction_set=instruction_set)
    ...
    def delete_set(self, name: str) -> bool:
        ...
        """
        return self._instruction_sets_manager.delete_set(name=name)
    ...
    def rename_set(self, old_name: str, new_name: str) -> bool:
        ...
        """
        return self._instruction_sets_manager.rename_set(old_name=old_name, new_name=new_name)
    ...
    def _load_data_from_settings(self) -> None:
        ...
        if serialized_data:
            try:
                self._instruction_sets_manager.import_from_dict(data=serialized_data)
    ...
    def _ensure_valid_state(self) -> None:
        ...
        if not has_instruction_sets:
            default_instruction_set = InstructionSet.get_default()
            self._instruction_sets_manager.add_set(instruction_set=default_instruction_set)

        # Ensure a valid selection
        is_valid_selection = self._selected_set_name and self._instruction_sets_manager.find_set_by_name(name=self._selected_set_name)
    ...
    def _save_to_settings(self) -> None:
        ...
        self._settings_manager.set_instruction_sets(instruction_sets_data=serialized_data)

        # Save selected set
        self._settings_manager.set_selected_instruction_set(name=self._selected_set_name)
