...
class InstructionSetsManager:
    ...
    def __init__(self):
        ...
        self._instruction_manager = CoreInstructionSetsManager()
    ...
    def _ensure_valid_state(self) -> None:
        ...
        has_instruction_sets = self._instruction_manager.get_all_sets()
        if not has_instruction_sets:
            default_set = InstructionSet.get_default()
            self._instruction_manager.add_set(default_set)
        
        # Ensure a valid selection
        is_valid_selection = (self._selected_set_name and self._instruction_manager.find_set_by_name(self._selected_set_name))           
        if not is_valid_selection:
            self._selected_set_name = self._instruction_manager.get_all_sets()[0].name
    ...
    def set_selected_set_name(self, instruction_set_name: str) -> bool:
        ...
        """
        instruction_set = self._instruction_manager.find_set_by_name(instruction_set_name)
