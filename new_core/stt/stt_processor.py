...
class STTProcessor:
    ...
    custom_vocabulary : List[str]
        List of domain-specific vocabulary to improve transcription accuracy
    ...
    def clear_custom_vocabulary(self) -> None:
        ...
        This removes all previously added custom vocabulary from the processor.
        """
    ...
    def add_transcription_instruction(self, instructions: Union[str, List[str]]) -> None:
        ...
        Notes
        -----
        These instructions guide the model on how to transcribe the audio.
    ...
    def clear_transcription_instructions(self) -> None:
        ...
        This removes all previously added instructions from the processor.
        """
        self.system_instructions = []
    
    def _create_system_prompt(self) -> Optional[str]:
        """
        Create a system prompt with vocabulary and instructions.
        ...
        Notes
        -----
        This internal method combines custom vocabulary and system instructions
        into a single prompt string that can be sent to the API.
        """
        prompt_parts = []
    ...
    def transcribe(self, audio_file_path: str, language: Optional[str] = None, 
        ...
        try:
            ...
            progress_tracker = ProcessTracker()
            
            # Split audio file into chunks
            audio_chunk_file_paths = chunker.chunk_audio_file(audio_file_path)
    ...
    def transcribe_file_with_chunks(self, audio_file_path: str, language: Optional[str] = None) -> str:
        """
        Transcribe an audio file using chunking.
        
        This is a convenience method that always uses chunking, even for small files.
        ...
        str
            Transcribed text.
        """
        return self.transcribe(audio_file_path, language, "text")
    ...
    def set_api_key(self, api_key: str) -> None:
        ...
        Notes
        -----
        This updates both the stored API key and reinitializes the client
        with the new key.
        """
        if not api_key:
